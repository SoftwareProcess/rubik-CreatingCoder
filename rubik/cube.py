...
##Top right corners of faces, that solve##
    ...
    def CornersAreSolved(encodedCube):
        if(encodedCube[45]==encodedCube[49] and encodedCube[46]==encodedCube[49] and encodedCube[47]==encodedCube[49] and encodedCube[48]==encodedCube[49] and 
            ...
            and encodedCube[16] == encodedCube[13] and encodedCube[17] == encodedCube[13] and encodedCube[24] == encodedCube[22] and encodedCube[25] == encodedCube[22] 
    ...
    @staticmethod
    def blueFaceMiddleRight(encodedCube, solution):
        rot = Cube.up(encodedCube)
        encodedCube = rot
        rot = Cube.right(encodedCube)
        encodedCube = rot
        ...
        rot = Cube.front(encodedCube)
        encodedCube = rot
        solution = solution + 'URurufUF'
        return (encodedCube, solution)
            
            
    @staticmethod
    def redFaceMiddleLeft(encodedCube, solution): 
        rot = Cube.upPrime(encodedCube)
        encodedCube = rot
        rot = Cube.frontPrime(encodedCube)
        encodedCube = rot  
        ...
        rot = Cube.rightPrime(encodedCube)
        encodedCube = rot    
        solution = solution + 'ufUFURur'
        return (encodedCube, solution)
        
    @staticmethod
    def redFaceMiddleRight(encodedCube, solution):
        rot = Cube.up(encodedCube)
        encodedCube = rot
        rot = Cube.back(encodedCube)
        encodedCube = rot
    ...
    @staticmethod
    def greenFaceMiddleLeft(encodedCube, solution):
        rot = Cube.upPrime(encodedCube)
        encodedCube = rot
        rot = Cube.rightPrime(encodedCube)
        encodedCube = rot
    ...
    @staticmethod
    def orangeFaceMiddleRight(encodedCube, solution):
        rot = Cube.up(encodedCube)
        encodedCube = rot
        rot = Cube.front(encodedCube)
        encodedCube = rot
    ...
    @staticmethod
    def blueFaceMiddleRightStatus(encodedCube):
        if(encodedCube[5]==encodedCube[4] and encodedCube[12]==encodedCube[13]):
                return True
        else:
            return False
    ...
    @staticmethod
    def redFaceMiddleLeftStatus(encodedCube):
        if(encodedCube[12]==encodedCube[13] and encodedCube[5]==encodedCube[4]):
                return True
        else:
            return False
    ...
    @staticmethod
    def greenFaceMiddleLeftStatus(encodedCube):
        if(encodedCube[21]==encodedCube[22] and encodedCube[14]==encodedCube[13]):
                return True
        else:
            return False
    
    @staticmethod
    def greenFaceMiddleRightStatus(encodedCube):
        if(encodedCube[23]==encodedCube[22] and encodedCube[30]==encodedCube[31]):
                return True
        else:
            return False
        
    @staticmethod
    def orangeFaceMiddleLeftStatus(encodedCube):
        if(encodedCube[30]==encodedCube[31] and encodedCube[23]==encodedCube[22]):
                return True
        else:
            return False
        
    @staticmethod
    def orangeFaceMiddleRightStatus(encodedCube):
        if(encodedCube[32]==encodedCube[31] and encodedCube[3]==encodedCube[4]):
                return True
        else:
            return False
