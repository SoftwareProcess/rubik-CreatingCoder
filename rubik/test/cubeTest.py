...
#======================================Start of Iteration 3 Tests================================   
    ...
    def test_checkCornersAreSolved_True(self):
    ...
    def test_checkCornersAreSolved_False(self):
    ...
    def test_middle_layer_blueface_left(self):
        encodedCube = 'obyrbgbbboobyrrrrrrygbgygggybgoogooorryyygyobwwwwwwwww'  
        solution = ""
        CubeObject = rubik.Cube()
        afterMethod = CubeObject.blueFaceMiddleLeft(encodedCube, solution)
        dataShouldEqual = ('oorbbgbbbgyoyrrrrrbgbbgygggrygooooooyryrybygywwwwwwwww', 'ulULUFuf')
        self.assertEqual(afterMethod, dataShouldEqual)
        
    
    def test_middle_layer_blueface_right(self):
        encodedCube = 'obybbgbbbrrryryrrryoobgygggbygooooooygbrygyrgwwwwwwwww'  
        solution = ""
        CubeObject = rubik.Cube()
        afterMethod = CubeObject.blueFaceMiddleRight(encodedCube, solution)
    ...
    def test_middle_layer_redface_right(self):
        encodedCube = 'oyrbbrbbbgrobrbrrryybygygggrgyooooooyrgoygbgywwwwwwwww'  
        solution = ""
        CubeObject = rubik.Cube()
        afterMethod = CubeObject.redFaceMiddleRight(encodedCube, solution)
        dataShouldEqual = ('rrrbbrbbbyyobrrrrrygyggygggoyyoooooobogbyggybwwwwwwwww', 'UBuburUR')
        self.assertEqual(afterMethod, dataShouldEqual)  
    
    
    def test_middle_layer_greenface_left(self):
        encodedCube = 'brybbrbbbrbybrgrrroggygggggooyooooooyrbyyyrygwwwwwwwww'  
        solution = ""
        CubeObject = rubik.Cube()
        afterMethod = CubeObject.greenFaceMiddleLeft(encodedCube, solution)
        dataShouldEqual = ('ygybbrbbbbrybrrrrroogggggggyyooooooorybbyygyrwwwwwwwww', 'urURUBub')
        self.assertEqual(afterMethod, dataShouldEqual)
    
    
    def test_middle_layer_greenface_right(self):
        encodedCube = 'yrgbbrbbboygbrgrrrygbrgygggybrooooooooryygbyywwwwwwwww'  
        solution = ""
        CubeObject = rubik.Cube()
        afterMethod = CubeObject.greenFaceMiddleRight(encodedCube, solution)
        dataShouldEqual = ('oorbbrbbbgyybrgrrrbybrgggggyrgooooooogryybyyywwwwwwwww', 'ULulubUB')
        self.assertEqual(afterMethod, dataShouldEqual)
        
    def test_middle_layer_orangeface_left(self):
        encodedCube = 'gyybbrbbbrrbbrrrrrybrggygggyoygooooobyogyyoogwwwwwwwww'  
        solution = ""
        CubeObject = rubik.Cube()
        afterMethod = CubeObject.orangeFaceMiddleLeft(encodedCube, solution)
        dataShouldEqual = ('bygbbrbbboyybrrrrrrrrggggggyyooooooobygoygybywwwwwwwww', 'ubUBULul')
        self.assertEqual(afterMethod, dataShouldEqual)
        
    def test_middle_layer_orangeface_right(self):
        encodedCube = 'yybgbrbbbyybbrrrrrrogggggggyooooyoooryybybgrowwwwwwwww'  
        solution = ""
        CubeObject = rubik.Cube()
        afterMethod = CubeObject.orangeFaceMiddleRight(encodedCube, solution)
        dataShouldEqual = ('yybbbrbbbrgrbrrrrrgryggggggooooooooobyyyyygbywwwwwwwww', 'UFufulUL')
        self.assertEqual(afterMethod, dataShouldEqual)
        
    def test_middle_layer_blueface_left_true(self):
        encodedCube = 'bbbbbbbbbrrrrrrrrrgggggggggoooooooooyyyyyyyyywwwwwwwww'  
        CubeObject = rubik.Cube()
        afterMethod = CubeObject.blueFaceMiddleLeftStatus(encodedCube)
        dataShouldEqual = (True)
        self.assertEqual(afterMethod, dataShouldEqual)
        
    
    def test_middle_layer_blueface_right_true(self):
        encodedCube = 'bbbbbbbbbrrrrrrrrrgggggggggoooooooooyyyyyyyyywwwwwwwww'  
        CubeObject = rubik.Cube()
        afterMethod = CubeObject.blueFaceMiddleRightStatus(encodedCube)
        dataShouldEqual = (True)
        self.assertEqual(afterMethod, dataShouldEqual)
        
    def test_middle_layer_redface_left_true(self):
        encodedCube = 'bbbbbbbbbrrrrrrrrrgggggggggoooooooooyyyyyyyyywwwwwwwww'  
        CubeObject = rubik.Cube()
        afterMethod = CubeObject.redFaceMiddleLeftStatus(encodedCube)
        dataShouldEqual = (True)
        self.assertEqual(afterMethod, dataShouldEqual)
        
    
    def test_middle_layer_redface_right_true(self):
        encodedCube = 'bbbbbbbbbrrrrrrrrrgggggggggoooooooooyyyyyyyyywwwwwwwww'  
        CubeObject = rubik.Cube()
        afterMethod = CubeObject.redFaceMiddleRightStatus(encodedCube)
        dataShouldEqual = (True)
        self.assertEqual(afterMethod, dataShouldEqual)
        
    def test_middle_layer_greenface_left_true(self):
        encodedCube = 'bbbbbbbbbrrrrrrrrrgggggggggoooooooooyyyyyyyyywwwwwwwww'  
        CubeObject = rubik.Cube()
        afterMethod = CubeObject.greenFaceMiddleLeftStatus(encodedCube)
        dataShouldEqual = (True)
        self.assertEqual(afterMethod, dataShouldEqual)
        
    def test_middle_layer_greenface_right_true(self):
        encodedCube = 'bbbbbbbbbrrrrrrrrrgggggggggoooooooooyyyyyyyyywwwwwwwww'  
        CubeObject = rubik.Cube()
        afterMethod = CubeObject.greenFaceMiddleRightStatus(encodedCube)
        dataShouldEqual = (True)
        self.assertEqual(afterMethod, dataShouldEqual)
        
    def test_middle_layer_orangeface_left_true(self):
        encodedCube = 'bbbbbbbbbrrrrrrrrrgggggggggoooooooooyyyyyyyyywwwwwwwww'  
        CubeObject = rubik.Cube()
        afterMethod = CubeObject.orangeFaceMiddleLeftStatus(encodedCube)
        dataShouldEqual = (True)
        self.assertEqual(afterMethod, dataShouldEqual)
        
    def test_middle_layer_orangeface_right_true(self):
        encodedCube = 'bbbbbbbbbrrrrrrrrrgggggggggoooooooooyyyyyyyyywwwwwwwww'  
        CubeObject = rubik.Cube()
        afterMethod = CubeObject.orangeFaceMiddleRightStatus(encodedCube)
        dataShouldEqual = (True)
        self.assertEqual(afterMethod, dataShouldEqual)
